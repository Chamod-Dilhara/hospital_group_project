        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF203A43).withOpacity(0.15),
                  blurRadius: 30,
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Successfully Saved!',
                  style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF203A43)),
                ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      side: const BorderSide(color: Color(0xFF203A43), width: 2),
